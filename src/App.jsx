  ...
  return (
    <>
      ...
      <main className='bg-yellow-200/20 min-h-screen'>
        <div className="header mt-16 text-gray-700  font-serif text-center pt-12 text-5xl" >Micro-Fact Coach</div>
        <div className="card bg-white h-fit w-11/12 md:w-3/5 lg:w-2/5 mx-auto mt-10 p-6 rounded-lg shadow-lg">
        <div className="fact h-fit bg-green-300/20 w-full rounded-lg p-4">
